...
tsunade = Usuario.create([{Nome: 'Tsunade', Email: 'tsunade@konoha.com', CPF: '02081948306', NomeDeUsuario: 'Tsunade', password_digest: BCrypt::Password.create('sennin'), TipoDeConta: 'Tatuador', foto_de_perfil_blob: ActiveStorage::Blob.create_and_upload!(io: File.open('photos/tsunade.png'), filename: 'tsunade.png'), Celular: '11 987862333', Instagram: '@tsunade'}])
kakashi = Usuario.create([{Nome: 'Kakashi', Email: 'kakashi@konoha.com', CPF: '15091970705', NomeDeUsuario: 'Kakashi', password_digest: BCrypt::Password.create('copying_ninja'), TipoDeConta: 'Tatuador', foto_de_perfil_blob: ActiveStorage::Blob.create_and_upload!(io: File.open('photos/kakashi.png'), filename: 'kakashi.png'), Celular: '11 952527445', Instagram: '@sharingannokakashi'}])
...
team_7 = Post.create([{titulo: 'Time 7', foto_blob: ActiveStorage::Blob.create_and_upload!(io: File.open('photos/team7.png'), filename: 'team7.png'), tag_list: 'Time 7, Naruto, Sasuke, Sakura, Kakashi', usuario_id: '7'}])
...
team_sennin = Post.create([{titulo: 'Os Três Sennins Lendários', foto_blob: ActiveStorage::Blob.create_and_upload!(io: File.open('photos/sennin.png'), filename: 'sennin.png'), tag_list: 'Sennin, Orochimaru, Jiraiya, Tsunade', usuario_id: '4'}])
